...
| Terminal API | `src/internal/api/tmux.go` | inventory and capture; create, split, layout, buffer/paste/send, kill, rename, key and option changes |
...
No prototype used `/run/user/<uid>/chrote-tmux` or a live session. Each tmux
