...
whole org). **Senior architect** (e.g. `atlas`): `kind=claude-code`, `agent_md=/home/alice/chrote/CLAUDE.md`,
...
beads_workspace = "/home/alice/chrote"   # where this team tracks work
```
